...
def main():
    ...
    carpeta_base = Path(
        ruta_parquet
    ).parent.parent  # Subir desde silver/ a carpeta base
    ...
    print("   └── actual/        (Power BI apunta aquí - se sobreescribe)")
    print("       ├── Planilla Metso - Regimen Minero.parquet")
    if ruta_excel_gold_actual is not None:
        print("       └── Planilla Metso - Regimen Minero.xlsx")
