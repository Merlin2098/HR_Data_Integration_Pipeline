...
def enriquecer_nomina_con_licencias(
    ruta_nomina: Path, ruta_licencias: Path
) -> pl.DataFrame:
    """
    ...
    print("   → Ejecutando agregación y join...")
...
def main():
    ...
    try:
        ...
        df_enriquecido = enriquecer_nomina_con_licencias(ruta_nomina, ruta_licencias)
